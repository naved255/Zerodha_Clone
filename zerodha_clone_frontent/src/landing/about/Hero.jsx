...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-16">
      {/* Heading */}
      <p className="text-2xl md:text-3xl font-semibold text-center max-w-4xl mx-auto leading-relaxed">
      ...
      {/* Content */}
      <div className="grid gap-10 md:grid-cols-2 max-w-6xl mx-auto text-lg text-gray-600">
        {/* Left column */}
